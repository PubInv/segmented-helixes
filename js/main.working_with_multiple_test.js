        ...
        for(var i = 0; i < 3; i++) {
            for(var j = 0; j < 3; j++) {
                for(var k = 0; k < 3; k++) {
                    for(var l = 0; l < 3; l++) {
                        for(var m = 0; m < 3; m++) {                                            
                            test_gen[i*81+j*27+k*9+l*3+m] = "(i) => { return i<20 ? [ "+i+","+j+","+k+","+l+","+m+"][i%5]: -1; }";
                        }
                    }
                }
            }
        ...
        test_gen.forEach( (x,i) => 
                          {
                              ...
                              console.log("AAA");
                              const square = 14;
                              var x = Math.floor(i / square);
                              var y = i % square;
                              const space = 4;
                              var other_params = initialParameters(new THREE.Vector3(x*space,0,y*space));
                              console.log("BBB");                                                            
                              console.log("CCC");                                                                                          
